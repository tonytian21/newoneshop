		...
		if(jwebox_shopid&&jwebox_shopid==shopid&&jwebox.DOMS['goshopnow']){		 
			...
			var html = jwebox.heredoc(function(){/*	
				...
				*{margin:0;padding:0;list-style-type:none;}
				...
				.jwebox_webox{position:fixed;_position:absolute;z-index:9999;padding:8px;;_background:#777;background:#f60;border-radius:5px;}
				.jwebox_webox .jwebox_inside{background-color:#FFFFFF;height:280px;z-index:999;}
				.jwebox_webox .jwebox_inside h1,.jwebox_locked h1{align:center;-moz-user-select:none;-webkit-user-select:none;position:relative;display:block;margin:0;padding:0;font-size:13px;line-height:25px;height:30px;padding-left:5px;font-family:Arial;background:#f60;font-weight:normal;cursor:move;font-weight:800;color:#fff;}
				...
				.jwebox_Det_Shopnow{width:94px;height: 34px;background: #f60;text-align: center;line-height: 32px;
				...
				.jwebox_mainlist_uspecies1{margin-top:20px;display:block;width:260px;height:50px;line-height:50px;background-color:#f60;border-radius:10px;color:#fff;font-size:16px;font-weight:600;}
				.buxianshi:hover{background-color:#fff!important;color:#f60!important;}
				</style>
			...
			var cgoodsinfo = jQuery.parseJSON(cgoodsdata);
                ...
                if(cgoodsinfo.ustatus==2){
                    ...
                    $(".jwebox_uspecies").html("<span style='color:#f60;font-weight:600;'>"+cgoodsinfo.umoney+"</span>");
                    ...
                    if(cgoodsinfo.ustatus==0){
                        ...
                        $(".jwebox_mainlist_uspecies").css("color","#f60");
...
shopnum.keyup(function(){			
	...
	$("#yshopchance").html("<span style='color:#f60'>获得机率"+baifenbi+"</span>");   			
});			
