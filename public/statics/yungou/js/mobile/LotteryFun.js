                ...
                if (s.code == 0) {
                    ...
                    for (var q = 0; q < t; q++) {
                            if(r[q].userphoto!='photo/member.jpg') {
                                var v = '<ul id="' + r[q].id + '"><li class="revConL">' + (r[q].codeType == 1 ? '<span class="z-limit-tips">' + getJsLang("限时揭晓") + '</span>': "") + '<img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + r[q].thumb + '"></li><li class="revConR"><dl><dd class="touxianga"><img name="uImg" uweb="' + r[q].q_uid + '" src="'+Gobal.imgpath+'/uploads/' + r[q].userphoto + '"></dd><dd><span>' + getJsLang("获得者") + '<strong>：</strong><a name="uName" uweb="' + r[q].q_uid + '" class="rUserName blue">' + r[q].q_user + '</a></span>' + getJsLang("本期购买") + '<strong>：</strong><em class="orange arial">' + r[q].gonumber + '</em>' + getJsLang("人次") + '</dd></dl><dt>' + getJsLang("幸运码") + '：<em class="orange arial">' + r[q].q_user_code + '</em><br/>' + getJsLang("揭晓时间") + '：<em class="c9 arial">' + r[q].q_end_time + '</em></dt><b class="fr z-arrow"></b></li></ul>';
                            }else if(r[q].userphotow!=''){
                                var v = '<ul id="' + r[q].id + '"><li class="revConL">' + (r[q].codeType == 1 ? '<span class="z-limit-tips">' + getJsLang("限时揭晓") + '</span>': "") + '<img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + r[q].thumb + '"></li><li class="revConR"><dl><dd class="touxianga"><img name="uImg" uweb="' + r[q].q_uid + '" src="'+r[q].userphotow+'"></dd><dd><span>' + getJsLang("获得者") + '<strong>：</strong><a name="uName" uweb="' + r[q].q_uid + '" class="rUserName blue">' + r[q].q_user + '</a></span>' + getJsLang("本期购买") + '<strong>：</strong><em class="orange arial">' + r[q].gonumber + '</em>' + getJsLang("人次") + '</dd></dl><dt>' + getJsLang("幸运码") + '：<em class="orange arial">' + r[q].q_user_code + '</em><br/>' + getJsLang("揭晓时间") + '：<em class="c9 arial">' + r[q].q_end_time + '</em></dt><b class="fr z-arrow"></b></li></ul>';
