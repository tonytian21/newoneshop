    ...
    var b = function() {
        ...
        var q = function(y) {
            ...
            if (y > 0) {
                ...
                c.attr("sel", "1").attr("class", "z-pay-mentsel sle").next("span").html('金币支付<em class="orange">' + y + ".00</em>元（您的金币：" + t + "）")
				$("#payact").val("zh");
                checkpay='fufen';
				banktype='nobank';
            } else {
                c.attr("sel", "0").attr("class", "z-pay-ment sle").next("span").html('金币支付<em class="orange">0.00</em>元（您的金币：' + t + "）")
            }
        };
        var f = function(y) {
