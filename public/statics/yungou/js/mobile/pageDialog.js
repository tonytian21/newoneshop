(function(a) {
    ...
    a.PageDialog.confirm = function(g, c, b) {
        ...
        var d = '<div class="clearfix m-round u-tipsEject"><div class="u-tips-txt">' + g + '</div><div class="u-Btn"><div class="u-Btn-li"><a href="javascript:;" id="btnMsgCancel" class="z-CloseBtn">'+getJsLang('取消')+'</a></div><div class="u-Btn-li"><a id="btnMsgOK" href="javascript:;" class="z-DefineBtn">'+getJsLang('确定')+'</a></div></div></div>';
