        ...
        if (l.code == 0) {		 
		  ...
		  if(l.contcode==0){
            ...
            var k = '<div class="infoResult">';           
                ...
                k += "<dl>"+getJsLang("截止揭晓时间*最后100条")+"</dl>";
            ...
            if (s > 0) {			
                ...
                k += '<ul class="result2"><li class="iTitle"><span>'+getJsLang("购买时间")+'</span><span>'+getJsLang("转换数据")+'</span><span>'+getJsLang("会员账号")+'</span></li>';
            ...
            k += '<div class="infoCount"><div class="infoCount2"><ul><li style="border:0 none;">'+getJsLang("取以上数值结果得")+'：</li><li>1、'+getJsLang("求和")+'：' + r + "<em>("+getJsLang("上面100条购买记录时间取值相加之和")+")</em></li><li><p>2、"+getJsLang("取余")+"：" + r + "<em>("+getJsLang("100条时间记录之和")+")</em><br/>%" + j + "<em>("+getJsLang("本商品总需参与人次")+")</em>=" + p + "<em>(余数)</em></p></li><li>3、"+getJsLang("计算结果")+"：" + p + "<em>("+getJsLang("余数")+")</em>+10000001=<span>" + q + "</span></p>" + (q != n ? '<li><p style="text-indent:-6.6em; padding-left:80px;">4、最终结果：' + q + " 未被购买，取差值最小的购买码 " + n + " 为幸运码</p></li>": "") + "</div></div>";
				...
				var k = '<div class="infoCount"><div class="infoCount2"><ul><li style="text-align:center;border:0 none;">未满100条计算结果</li><li ">取以上数值结果得：</li><li>1、'+getJsLang("求和")+'：' + r + "<em>("+getJsLang("上面100条购买记录时间取值相加之和")+")</em></li><li><p>2、"+getJsLang("取余")+"：" + r + "<em>("+getJsLang("100条时间记录之和")+")</em><br/>%" + j + "<em>("+getJsLang("本商品总需参与人次")+")</em>=" + p + "<em>("+getJsLang("余数")+")</em></p></li><li>3、"+getJsLang("计算结果")+"：" + p + "<em>("+getJsLang("余数")+")</em>+10000001=<span>" + q + "</span></p>" + (q != n ? '<li><p style="text-indent:-6.6em; padding-left:80px;">4、最终结果：' + q + " 未被购买，取差值最小的购买码 " + n + " 为幸运码</p></li>": "") + "</div></div>";
