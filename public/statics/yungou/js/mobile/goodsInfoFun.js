$(function() {
    ...
    if (m) {
        ...
        Base.getScript(Gobal.JsPath + "/mobile/GoodsTimeFun.js",
        ...
        Base.getScript(Gobal.JsPath + "/mobile/pageDialog.js", i);
        ...
        if (g.length > 0) {
            ...
            if (o) {
                ...
                Base.getScript(Gobal.JsPath + "/mobile/CountdownFun.js",
    ...
    var a = function() {
        ...
        Base.getScript(Gobal.JsPath + "/mobile/GoodsPicSlider.js?v=130826",
    ...
    Base.getScript(Gobal.JsPath + "/mobile/PeriodSlider.js?v=130826", a)
