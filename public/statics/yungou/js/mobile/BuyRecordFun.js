    ...
    $("#btnSort").click(function() {
        ...
        if (!k) {
            ...
            if (i.sort == 0) {
                ...
                $(this).html('<i></i>'+getJsLang("排序")+'<s class="z-Sswt"></s><s class="z-Sswd"></s>');

                i.sort = 1

            } else {

                $(this).html('<i></i>'+getJsLang("排序")+'<s class="z-SswOn"></s><s class="z-SswNt"></s>');
