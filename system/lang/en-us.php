...
return $_lang_en = [
	...
	"两次新密码输入不一致哦"=>" New password confirmation does not match.",
	...
	"木有了"=>" End, head to the latest batch",
	...
	"晒单时间"=>" sharing time",
	"总共OneShop"=>" total",
	"公平公正"=>" 100% fair and just",
	"参与过程公开透明"=>" Transparent",
	"正品保证"=>" 100% authentic",
	"品牌正品"=>" Carefully selected high-quality products, 100% authentic brand",
	"全国免运费"=>" free shipping",
	...
	"查看"=>" View",
	"订单添加失败"=>" failed to add, please return to shopping cart",
