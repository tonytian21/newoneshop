...
return array(
    ...
    '恭喜您,支付成功' => 'Congratulations on your success!',
    '总需人次' => 'Total',
    ...
    '找到<em class="orange">%s</em>关于<em class="orange">%s</em>的商品' => 'Search <em class="orange">%s</em> for <em class="orange">%s</em> products',
    '收货地址管理' => 'My Addresses',
    ...
    "金币" => "RM",
    "是，马上收货"=>"Yes, I'll take them right away.",
      "否，暂时别发货"=>"No, not for the time being."
