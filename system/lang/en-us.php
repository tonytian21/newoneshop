...
return $_lang = [
	...
	"您的当前金币"=>"Your current 1Shop coins",
	...
	"1金币等于1元"=>"Notice: 1 Oneshop coin equavalent to RM1",
	"金币"=>"1Shop coin",
	...
	"佣金"=>"Commission",
	"使用佣金充值到1Shop账户"=>"Use commission to reload to your 1Shop account",
	...
	"金币回报率"=> "Spend 1Shop coin and win <span class='c_red'>%s</span>, the rate of return: <span class='c_red t18'>%s</span> times",
	'倍' => "Times ",
	"字母或数字" => "Letters or Numbers",
	"请完善个人信息" => "Please complete your personal information",
	"首先" => "First ",
    "两次的用户信息不一致，请重新输入"=>"两次的用户信息不一致，请重新输入",
	"如何开始" => "如何开始？",
