...
<div class="table_form lr10">
	...
	<form name="myform" action="" method="post" enctype="multipart/form-data">
		<table width="100%" class="lr10">
			...
			<tr class="couplet_img" style="display:none">
				<td align="right">左边广告图片：</td>
				<td>
					<input type="text" name="couplet_left" id="imagetext1" class="input-text wid300">
					<input type="button" class="button"
			...
			<tr class="couplet_img" style="display:none">
				<td align="right">右边广告图片：</td>
				<td>
					<input type="text" name="couplet_right" id="imagetext2" class="input-text wid300">
					<input type="button" class="button"
