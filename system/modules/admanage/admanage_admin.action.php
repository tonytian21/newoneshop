	...
	public function adadd(){
		...
		if(isset($_POST['submit'])){
			...
			if($type=="text"){
				...
				$des=trim($des,'.');			
			}elseif($type=='couplet'){/*对联广告类型*/
				$des1=isset($_POST['couplet_left']) ? $_POST['couplet_left'] : '';
				$des2=isset($_POST['couplet_right']) ? $_POST['couplet_right'] : '';
				$des=trim($des1.",".$des2,'.');
			}
