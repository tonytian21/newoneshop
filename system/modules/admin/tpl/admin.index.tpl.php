...
.header_case{  position:absolute; right:10px; top:10px;}
.header_case a{ padding-left:5px}
.left_date li span{background: url(<?php echo G_WEB_PATH; ?>/plugin/style/global/image/narrow.png);display:inline-block; height: 35px; margin-left: 15px; width: 10px;}
...
.left_date li:hover{ background-color:rgba(238, 238, 238, 0.72);text-decoration:none;border-bottom:1px solid #3c8dbc;height: 34px; cursor: pointer;}

.left_date .set{background-color:rgba(238, 238, 238, 0.72);border-bottom: 1px solid #195565;font-weight:bold;color:#3c8dbc;}

.left_date .head{border-bottom: 1px solid #195565; font-size:14px; font-weight:bold;background:rgba(238, 238, 238, 0.72);padding-left:15px; height: 34px;}
...
<div id="header">
    ...
    <div class="nav" id="nav" style="left: 174.5px;top: 61px;">    
	...
	<li class="head">站长运营</li>
     ...
     <ul class="left_date" id="shop">   
       ...
       <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists">订单列表</a></li>
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists/zj">中奖订单</a></li> 
