...
<form name="myform" action="" method="post">
  ...
  <table width="100%" cellspacing="0">	
		...
		<tr>
			...
			<td width="220" align="right">网站语言包：</td>

			<td>
				<select name="lang" class="input-text">
					<option value="zh-cn" <?php if($web['lang'] == 'zh-cn') echo "selected";?>>zh-cn</option>
					<option value="en-us" <?php if($web['lang'] == 'en-us') echo "selected";?>>en-us</option>
				</select>
			<span></span>
