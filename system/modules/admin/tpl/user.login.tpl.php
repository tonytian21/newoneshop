...
<div class="login_box">
	...
	<div class="input_box">
	    <div class="lf input_caption tac">
	        <img src="<?php echo G_WEB_PATH; ?>/plugin/style/global/image/user.png" class="input_caption_img">
	    </div>
	...
	<div class="input_box">
	    <div class="lf input_caption tac">
	        <img src="<?php echo G_WEB_PATH; ?>/plugin/style/global/image/pwd.png" class="input_caption_img">
	    </div>
	    <div class="lf input_value">
	...
	<div class="input_box lf wid260" <?php if(!_cfg("web_verify")){ ?> style="filter:alpha(opacity=0);-moz-opacity:0; opacity:0;" <?php } ?>>
	                    <div class="lf input_caption tac">
	        <img src="<?php echo G_WEB_PATH; ?>/plugin/style/global/image/yzm.png"  class="input_caption_img">
	    </div>
	    <div class="lf input_value">
...
<div class="copyright lh30" style="padding-top:30px;">
   <a href="http://pv.sohu.com/cityjson"  target=_blank>警告：本平台已接入天网安全系统，已记录IP，严禁任何非正常登入</a> 
</div>
