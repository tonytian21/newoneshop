...
<style>
	...
	.div-system{background-color:#fff; float:left; padding:20px; margin:0 10px; border-right: 1px dashed #ddd}

	.div-webinfo{background-color:#fff; float:left; padding:20px; margin:0 10px; width:27%;border-right: 1px dashed #ddd}
...
<!------------>
<div class="aa" style="margin-top:10px;"></div>
	...
	<div class="job">
		<div class="right">
			<img src="<?php echo G_WEB_PATH ?>/plugin/style/global/image/u93.png" >
		</div>
		<div class="left">
