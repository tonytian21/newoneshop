...
<div class="header-data lr10">
	<b>提示:</b> <font color="red">重置本期商品的【价格】 会导致已经生成的交易记录清空！同时资金退回到会员的账户中，且用户的资金流水中可以看到此笔流水</br>
	 （已参与人数为【0】的商品不受影响）</font>
	<br/>
...
$("#form_post").submit(function(){
	...
	if(canyurenshu>0){
		var s = confirm("参与人数不为0,将会清空会员购买记录，并退还用户金额，用户在个人资金记录中可以看到此笔退款流水，是否继续");
		if(!s){
			return false;			
		}
	}
