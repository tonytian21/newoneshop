...
<form method="post" action="" onSubmit="return CheckForm()">
	<table width="100%"  cellspacing="0" cellpadding="0">
		...
		<tr style="background-color:#FFC">
			...
			<td>
				<b>提示：</b> <font color="red">商品总价格请不要填写100，2300,5000这样的整数,整数价格计算出的1Shop码可能就为10000001</font><br />
		...
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>1Shop单次价格：</td>
        ...
        <tr>
       	...
       	<tr>
			...
			<td>
             ...
             <input value="清空时间" onClick="" type="button">    
