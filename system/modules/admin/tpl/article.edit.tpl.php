...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
        ...
        <tr>
			...
			<td><textarea name="description" value="<?php echo $info['description']; ?>"  class="wid400" onKeyUp="gbcount(this,250,'textdescription');" style="height:60px"></textarea><br> <span>还能输入<b id="textdescription">250</b>个字符</span>
            </td>
		</tr>
     <tr>
