...
<div class="header-title lr10">
	...
	<span class="lr10"> | </span>
    <b><a href="https://shop143036786.taobao.com/" target="_blank" >短信充值购买</a><b>
</div>
<div class="bk10"></div>
<div class="lr10" id="div_top_block" style="display:block; width:100px; height:0px;background:#d5dfe8;">

</div>
<h2 style=" text-align:center; color:rgb(0,255,0); padding-left:200px">这里的配置不要动，不好配置</h2>
...
<table width="100%" class="meg_table">
	<tr>
    	<td width="100"><b>唐唐短信(推荐)</b><em style="color:red;"> <!--[new]--></em></td> 
   		<td key="4" class="mobile_on_off"></td>
    </tr>
    <tr>
       <td width="100">客户ID：</td> 
       <td><input type="text" name="userid" class="input-text wid150" value="<?php echo $mobiles['cfg_mobile_4']['userid']; ?>"></td> 
    </tr>    
    <tr>
    	<td width="100">短信接口用户名：</td> 
   		<td><input type="text" name="mid" class="input-text wid150" value="<?php echo $mobiles['cfg_mobile_4']['mid']; ?>"></td>
    </tr>
    <tr>
    	<td width="100">短信接口密码：</td> 
   		<td><input type="password" name="mpass" class="input-text wid150"  value="******"></td>
	...
	<tr>
		<td width="100">短信签名：</td>
		<td><input type="text" name="mqianming" class="input-text wid150"  value="<?php echo $mobiles['cfg_mobile_4']['mqianming']; ?>">
			必填！ 格式为: <font color="red">【你的签名】</font>
		</td>
	</tr>
	 <tr>
	 <td width="100">短信信息：</td>
	 <td>
     <span><?php echo $mobiles['cfg_mobile_4']['mobile_text']; ?></span>
     </td>
     </tr>
     
    <tr>
    	<td width="100" height="50"><input type="hidden" name="interface" value="4" /></td> 
   		<td> <input type="submit" value=" 提交并启用该接口 " name="dosubmit" class="button"></td>
    </tr>
     <tr>
    	<td width="100" height="20px;" style="border:0px;"></td> 
