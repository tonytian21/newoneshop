...
<li id='Page_Prev'><a href="<?php echo WEB_PATH.'/admin/auto/show/'.$o_p;?>">上一页</a></li>

<li id='Page_Next'><a href="<?php  echo WEB_PATH.'/admin/auto/show/'.$n_p;?>">下一页</a></li>

<li id='Page_One'><a href="<?php echo WEB_PATH.'/admin/auto/show/1';?>">首页</a></li>
