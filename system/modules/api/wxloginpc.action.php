...
class wxloginpc extends SystemAction {
	...
	public function init(){
		$wxurl = "https://open.weixin.qq.com/connect/qrconnect?appid=".$this->conf['weixinpc']['id'].'&redirect_uri='.urlencode(WEB_PATH.'/api/wxloginpc/callback')."&response_type=code&scope=snsapi_login&state=wechat12345#wechat_redirect";
