...
<div class="login">
	...
	<div class="login_bg">
		...
		<form class="registerform" method="post" action="">
			<h3><span style="display:block;float: left;">用户登录</span><a id="hylinkRegisterPage" style="padding:0px 10px;display: block;float: right;font-size: 16px;color: #f60;" tabindex="4" class="reg" href="<?php echo WEB_PATH; ?>/register">免费注册>></a></h3>
			<ul>				
				<li class="click">
					<input style="color: #666;" placeholder="邮箱地址" class="text_password" name="username" type="text"  />
			...
			<?php 
             ...
             ?>
            <?php if($conn_cfg['qq']['off'] or $conn_cfg['weixinpc']['off'] or $conn_cfg['facebook']['off']): ?>
 			<div class="loginQQ">
 				<span id="qq_login_btn">
 					使用其它方式快捷登录：
 				</span>
 				<?php if($conn_cfg['facebook']['off']): ?><a class="facebookdenglu" style="background:#3d589b url(<?php echo G_TEMPLATES_STYLE; ?>/images/facebook_icon.png) no-repeat 5px center; padding-left:26px; background-size: auto 70%;" href="<?php echo G_WEB_PATH; ?>/index.php/api/facebooklogin/"><b></b>FaceBook</a><?php endif; ?>
  				<?php if($conn_cfg['qq']['off']): ?><a class="qqdenglu" href="<?php echo G_WEB_PATH; ?>/index.php/api/qqlogin/"><b class="passport-icon1 transparent-png"></b></a> <?php endif; ?>	
  				<?php if($conn_cfg['weixinpc']['off']): ?><a class="weixindenglu" href="<?php echo G_WEB_PATH; ?>/index.php/api/wxloginpc/"><b style="background-position: 8px -149px!important;" class="passport-icon1 transparent-png"></b></a><?php endif; ?>	
 			</div>
