...
<div class="shop_payment">
	...
	<div class="payment_Con">
		<ul class="order_list">
			<li class="top">
				...
				<span class="moneys">次数</span>
				<span class="money">乐购价</span>
				<span class="num1">乐购人次</span>
				<span class="all">我的次数</span>
			</li>           
			...
			<li class="end">
				...
				<span class="moneyss"><?php echo $shops['money']; ?></span>
				<span class="moneyss"><span class="color"><b><?php echo $shops['yunjiage']; ?></b>乐购币</span></span>
				<span class="num1 orange Fb"><?php echo $shops['cart_gorenci']; ?></span>
			...
			<li class="payment_Total">
				...
				<p class="payment_List_Rc">商品合计：<span class="orange F20"><?php echo $MoenyCount; ?></span>乐币</p>
			</li>
			<!-- 积分 -->
            <?php if($fufen_dikou): ?>
			 <li id="liPayByPoints" class="point_out">
                    ...
                    <span class="orange Fb"><?php echo $fufen_dikou; ?>.00</span>乐币)，我要使用 
                    <input type="text" maxlength="8" class="pay_input_text_gray" id="shop_score_num" value="0" money="<?php echo $fufen['fufen_yuan']; ?>" name="shop_score_num"/> 积分, 1乐币 = <?php echo $fufen['fufen_yuan']; ?> 积分</div>
             ...
             <?php  else: ?>
              <li id="liPayByPoints" class="point_out point_gray">
					<div class="payment_List_Lc">
					<input type="checkbox" class="input_choice" disabled="disabled"/>使用积分抵扣现金：您的积分(<?php echo $member['score']; ?>)本次消费最多可抵扣现金
                    <span class="orange Fb"><?php echo $fufen_dikou; ?>.00</span>乐币)，我要使用 
			...
			<li class="point_in" id="liPayByBalance">
				<div class="payment_List_Lc">					
					...
					<span class="green F18"><?php echo $Money; ?></span>乐币
				</div>
				...
				<p class="payment_List_Rc">余额支付：<span id="pay_money" class="orange F20">0.00</span> 乐币</p>
			</li>
            <!-- 余额支付 end--> 
		
			<li id="liPayByOther" class="point_in point_bank" style="display:list-item;">
				<div class="payment_List_Lc gary01 Fb">您的账户乐币不足，请选择以下方式完成支付</div>
				<div class="payment_List_Lc gary01 Fb" style=" color:#f60;">1云币等于1元，请谨慎充值</div>
				<p class="payment_List_Rc">网银支付：<span id="pay_bankmoney" class="orange F20">0.00</span> 乐币</p>
			</li>
    ...
    <div class="payment_but" style="margin:15px 0 0 0;">
			...
			<input type="submit" id="submit_ok" class="shop_pay_but" name="submit" value="确认支付，下一步">
	</div>
    </form>
	<div class="answer">
		...
		<ul class="answer_list">
			...
			<li class="more"><a href="<?php echo WEB_PATH; ?>/help/liaojie">更多帮助</a>&nbsp;&nbsp;<a href="<?php echo WEB_PATH; ?>/member/home">进入我的乐购中心&gt;&gt;</a></li>
		</ul>
	</div>
