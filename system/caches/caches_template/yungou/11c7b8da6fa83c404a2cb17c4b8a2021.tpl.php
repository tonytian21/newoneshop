...
<div class="login_layout">
	...
	<div class="login_Content">          
		<div id="divVerify" class="login_CEmail hidden" style="display: none;">
			<dl>
				<dt><img src="<?php echo G_TEMPLATES_STYLE; ?>/images/login_exp03.png" border="0" alt=""></dt>
				<dd>
					<h2 class="orange Fb">您的帐号还未验证激活！</h2>
					<p class="login_fs14"><?php echo _cfg("web_name"); ?>已向您的 <span class="orange Fb">1234536@qq.com</span> 邮箱发送了一封验证邮件，请前往收信，完成验证！</p>
					<a id="hylinkMailsA" class="login_Email_but" href="http://mail.qq.com/" target="_blank">登录邮箱完成验证</a>                    
				</dd>
			</dl>
		</div>
		...
		<div id="divNormal" class="login_CMobile_Complete hidden" style="display: block;">
            ...
            <?php  else: ?>            
			<p><?php echo _cfg("web_name"); ?>已向您的 <span class="orange"><?php echo $name; ?></span> 邮箱发送了一封验证邮件，请前往收信，完成验证!</p>
