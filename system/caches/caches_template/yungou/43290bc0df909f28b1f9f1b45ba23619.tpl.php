        ...
        <header class="header" style="position: fixed;width: 100%;z-index: 99999999;">
            <h1 style="width: 100%;text-align: center;float: none;top: 0px;left: 0px;font-size: 25px;" class="fl">
				<span style="display: block;height: 49px;line-height: 49px;">
					<a style="font-size: 20px;line-height: 49px;" href="<?php echo WEB_PATH; ?>/mobile/mobile">帐号登陆</a>
				</span>
            ...
            <div class="registerCon" style="padding-top: 49px;">
                <ul>
                    ...
                    <li style="float: none;">
                        ...
                        <input name="hidLoginForward" type="hidden" id="hidLoginForward" value="<?php echo WEB_PATH; ?>/mobile/home" />
                    </li>
                    </li>
                    <li style="margin-top: 30px;text-align: center;">
                        <a style="height: 20px;line-height: 20px;color: #999!important;background: none;display: inline;font-size: 14px;margin-right: 10%;" href="<?php echo WEB_PATH; ?>/mobile/user/step1" class="nextBtn orgBtn" style="width:40%; float:right;">忘记密码?</a> |
                        <a style="height: 20px;line-height: 20px;color: #999!important;background: none;display: inline;font-size: 14px;margin-left: 10%;" href="<?php echo WEB_PATH; ?>/mobile/user/register" class="nextBtn orgBtn">免费注册</a>
                    </li>
                </ul>
                <div class="fastLogin" style="padding-top: 30px;">
                    <?php  $conn_cfg = System::load_app_config("connect",'','api');  ?>
                    <h2>
