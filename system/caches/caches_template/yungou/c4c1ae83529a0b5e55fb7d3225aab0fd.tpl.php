...
<div class="prin_pp w1222" style="margin-top:10px;height: 334px;overflow: hidden;text-align: center;">
    <ul id="prin_pp">
        ...
        <li class="b_gray">
            <div style="border: 0px solid #ffe9c7;height: 324px;overflow: hidden;">
...
<div class="goods_hot bt2_red w1200" style="margin-top:10px;">
    <div class="goods_hotL fl b_gray" style="border-top:0;margin-right:-1px;">
        ...
        <div class="title bb_gray bt_red">
            <p class="c_red"><?php echo lang::get_lang('正在OneShop'); ?></p>
        </div>
        <ul class="user">
            ...
            <li class="list-block">
                ...
                <div class="w-goods-ing">
                    <div class="shop_buttom bg_red b_red1">
                        <a href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqi['id']; ?>" title="<?php echo $renqi['title']; ?>" target="_blank" class="Det_Shopnow"><?php echo lang::get_lang('立即夺宝'); ?></a>
                    </div>
                </div>
            </li>
            <?php  endforeach; $ln++; unset($ln); ?>
        ...
        <li class="list-block">
            ...
            <div class="w-goods-ing" style="margin: 5px auto; width: 84%;">
                <div class="shop_buttom bg_red b_red1" style="">
                    <a href="<?php echo WEB_PATH; ?>/goods/<?php echo $shop['id']; ?>" target="_blank" style="font-size:14px;" class="Det_Shopnow"><?php echo lang::get_lang('立即夺宝'); ?></a>
                </div>
