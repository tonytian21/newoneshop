...
<div style="height: 36px;line-height: 36px;padding: 10px 0;font-size: 22px;width: 1201px;margin: 0 auto;">
    ...
    <div style="float: right;color: #ff6600;font-size: 14px;">
        <em class="gzwx_wx"></em>
        <a class="bs" href="<?php echo G_WEB_PATH; ?>/weixin/index.html" style="color: #ff6600;">关注<?php echo _cfg("web_name"); ?>官方微信，随时随地乐购！</a>
    </div>
</div>
