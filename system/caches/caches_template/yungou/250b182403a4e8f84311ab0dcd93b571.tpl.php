	...
	<?php if(defined('G_IN_ADMIN')) {echo '<div style="padding:8px;background-color:#F93; color:#fff;border:1px solid #f60;text-align:center"><b>This Tag</b></div>';}?>
		...
		<ul class="nav_list">
			<li class="sort-all-shouye">
				<a style="background-color: #f04900;" href="<?php echo G_WEB_PATH; ?>">首页</a>
			</li>
...
<style type="text/css">
	.qrcode {
	    ...
	    bottom: 100px;
	    width: 150px;
	    background: #FFF url("..<?php echo G_TEMPLATES_IMAGE; ?>/onlinebg.jpg") no-repeat scroll 0px 0px;
	...
	.qrcode .bd ul li .qq {
	    background: transparent url("..<?php echo G_TEMPLATES_IMAGE; ?>//btn_qqo.png") no-repeat scroll 0% 0%;
	}
	.qrcode .bd ul li .ww {
	    background: transparent url("..<?php echo G_TEMPLATES_IMAGE; ?>//btn_wwo.png") no-repeat scroll 0% 0%;
	}
