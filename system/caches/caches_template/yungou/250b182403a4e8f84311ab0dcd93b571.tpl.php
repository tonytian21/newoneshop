...
<head>
<meta property="qc:admins" content="0131730277621024463757" />
			...
			<div class="head_top w1200">
				<ul class="collect fr">
					<li class="fr"><a
						...
						qq"); ?>&site=qq&menu=yes " target="_blank">离线留言</a></li>
					...
					<li class="fr"><a href="<?php echo WEB_PATH; ?>/member/home/userrecharge">快速充值</a>
						<span>|</span></li>
					<li class="fr yu_ff"><a href="<?php echo WEB_PATH; ?>/home/member">我的云购</a>
						<span>|</span>
				...
				<ul class="collect fl">
					<li class="fl"><a style="margin-right: 3px;"
						href="javascript:;"
						onclick="AddFavorite(window.location,document.title)"><?php echo $this->_lang["收藏"]; ?></a> <!--<span>|</span>-->
					</li>
					<!--<li class="fl mobile" style="position:relative;width: 50px;padding:0 25px;">
						...
						<div class="h_mobile" style="padding:0 25px;width: 50px;height: 140px;z-index: 9999;">
							<dl>
								<li class="fl mobile">
									<a target="_blank"  style="margin:0;color: #ff6600;" href="<?php echo G_WEB_PATH; ?>/app/index.html">手机云购</a>
									<s style="left: 80px;"></s>
		...
		<div class="nav_center bg_red b_red w1200">
			...
			<ul class="nav_list">
				<li class="sort-all-shouye"><a
					style="background-color: #f04900;" href="<?php echo G_WEB_PATH; ?>">首页</a></li>
...
.qrcode {
	...
	bottom: 100px;
	width: 150px;
	background: #FFF url("..<?php echo G_TEMPLATES_IMAGE; ?>/onlinebg.jpg") no-repeat
		scroll 0px 0px;
...
.qrcode .bd ul li .qq {
	background: transparent url("..<?php echo G_TEMPLATES_IMAGE; ?>//btn_qqo.png")
		no-repeat scroll 0% 0%;
}

.qrcode .bd ul li .ww {
	background: transparent url("..<?php echo G_TEMPLATES_IMAGE; ?>//btn_wwo.png")
		no-repeat scroll 0% 0%;
}
