			...
			<div class="head_top w1200">
				<ul class="collect fr">
					...
					<li class="fr"><?php echo lang::get_lang('欢迎您'); ?>: <a href="<?php echo WEB_PATH; ?>/member/home"><?php echo get_user_name(get_user_arr(),'username'); ?></a>
						<span>|</span> <a href="<?php echo WEB_PATH; ?>/member/user/cook_end">[<?php echo lang::get_lang('退出'); ?>]</a>
						<span>|</span>
					</li> <?php  else: ?>
					<li class="fr"><a href="<?php echo WEB_PATH; ?>/register"><?php echo lang::get_lang('注册'); ?></a> <span>|</span>
					</li>
					<li class="fr"><a href="<?php echo WEB_PATH; ?>/login"><?php echo lang::get_lang('登录'); ?></a> <span>|</span>
					</li> <?php endif; ?>
				</ul>
				<ul class="collect fl">
...
$(function(){
	...
	$("#txtSearch").blur(function(){
		$("#txtSearch").css({background:"#FFF"});
		$(this).attr("placeholder","<?php echo lang::get_lang("输入'小米手机'试一试"); ?>");	
	});
