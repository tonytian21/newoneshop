...
<div class="R-content" style="position: relative;">
	...
	<div class="get-pro gray02">您总共成功夺得商品 <b id="goodsCount" class="orange" style="color: #f60;"><?php echo count($record); ?></b> 个
    	  <a href="#" id="wuliu_select">查询物流</a>
    </div>	
    <?php if(!member_get_dizhi($uid)): ?>    
    <div class="message" style="width: 300px;position: absolute;left: 300px;top: 55px;">你还没有填写收货信息,请填写收货信息！ <a href="<?php echo WEB_PATH; ?>/member/home/address" style="font-weight:bold; color:#2af">去填写!</a></div>
    <?php endif; ?>    
	...
	<div id="tbList" class="single-C list-tab">
		...
		<ul class="listTitle" style="background:#fff; height:80px; padding:10px 0 0 0;">
			<li class="single-img"><a target="_blank" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $recd['shopid']; ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo yunjl($recd['shopid']); ?>"></a></li>
			<li class="single-xx-has" style="margin-top: 15px;"><a target="_blank" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $recd['shopid']; ?>" style="line-height: 20px;">第<?php echo $recd['shopqishu']; ?>期<?php echo $recd['shopname']; ?></a>
