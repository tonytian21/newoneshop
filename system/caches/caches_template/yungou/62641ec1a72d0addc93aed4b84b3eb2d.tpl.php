...
<div class="wrap" id="loadingPicBlock">
	...
	<ul class="item" id="ulGoodsList">
		...
		<li class="goods-iten" >
			...
			<div class="Progress-bar">
				<p style=" height:5px;" title="已完成<?php echo percent($shop['canyurenshu'],$shop['zongrenshu']); ?>"><span style="height:6px;width:<?php echo width($shop['canyurenshu'],$shop['zongrenshu'],213); ?>px;"></span></p>
				<ul class="Pro-bar-li">
			...
			<div class="gl_buybtn" style="height: 50px;">
				<div class="go_buy">
					<a href="<?php echo WEB_PATH; ?>/go/index/item/<?php echo $shop['id']; ?>" title="立即云购" class="go_Shopping fl">立即1元云购</a>
					<a href="<?php echo WEB_PATH; ?>/go/index/item/<?php echo $shop['id']; ?>" title="加入购物车" class="go_cart fr"></a>
				</div>
			</div>
	...
	<?php  else: ?>
	<div class="NoConMsg w1200"><span>未找到有关“<em class="orange"><?php echo $search; ?></em>”的商品</span></div>
	<?php endif; ?>
</div>
