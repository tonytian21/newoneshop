            ...
            <div class="tabs-wrap" style="min-height:1000px;">
                ...
                -->
                    ...
                    <dl style="display:none;background: #fff;">
                        ...
                        <dd class="a1"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist"><img style="width: 30px;height: 30px;border-radius: 3px;float: left;margin:10px 5px 0 0;" src="<?php echo G_TEMPLATES_IMAGE; ?>/mobile/moren.png" alt="">全部分类</a></dd>
...
window.onload=function(){
    init_json("list/10");
    //购物车数量
    $.getJSON('/index.php/mobile/ajax/cartnum',function(data){
        if(data.num){
    ...
    function init_json(parm) {
        $("#urladdress").val('');
        $("#pagenum").val('');
        $.getJSON('/index.php/mobile/mobile/glistajax/' + parm, function(data) {
