...
<div class="footer mt20">
				...
				<ul class="mt10 ml10">
					<li>
						<a target="_blank" href="<?php echo G_WEB_PATH; ?>/weixin/index.html">
							<img src="<?php echo G_TEMPLATES_STYLE; ?>/images/code.jpg" height="75" width="75"></a>
					</li>
					<li>
						<dl>
							<dt>
	...
	<div class="g-copyrightCon">
		<div class="w1190">
			...
			<div class="g-copyright"><?php echo _cfg('web_copyright'); ?><br/>
            <a href="http://webscan.360.cn/index/checkwebsite/url/www.zyxztd.com"><img border="0" src="http://img.webscan.360.cn/status/pai/hash/95ea6031ca4686b86b6d9bb740e1ddcc/?size=74x27"/></a></div>
