...
<style type="text/css">
	*{margin:0;padding:0;}
	...
	.box-text{font:12px/1.5 "微软雅黑",Arial,"宋体",Helvetica,sans-serif; font-size:18px;color:#f60;width:400px;		
...
<div class="box">
	<div class="box-b">
        ...
        <div class="box-button"><a class="a-2" href="<?php echo $defurl; ?>"><font id="time" style="color:fff;"><?php echo $time; ?></font>秒后返回上一页面</a><a class="a-1" href="<?php echo $str_url_two['url']; ?>"><?php echo $str_url_two['text']; ?></a></div> 
