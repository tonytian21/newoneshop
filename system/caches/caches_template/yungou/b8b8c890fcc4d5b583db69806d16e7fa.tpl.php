...
#btnGotoTop .s1 {
    background: url(<?php echo G_TEMPLATES_IMAGE; ?>/mobile/fast-nav-new.png) 0 -163px no-repeat;
...
#btnGotoTop1 .s2 {
    background: url(<?php echo G_TEMPLATES_IMAGE; ?>/mobile/fast-nav-new.png) 0 -129px no-repeat;
    background-size: 21px auto;
    margin: 9px auto;
    display: block;
    width: 21px;
...
#btnGotoTop3 a i {
    background: url(<?php echo G_TEMPLATES_IMAGE; ?>/mobile/fast-nav-new.png) 0 0px no-repeat;
    width: 20px;
    height: 20px;
    margin: 10px 5px 0 0;
    display: block;
...
<div class="footerdi" style="bottom: 0px;">
    <ul>
        ...
        <li class="f_personal">
            <a title="我的乐购" href="<?php echo WEB_PATH; ?>/mobile/home">
                <i class="<?php echo $f_personal; ?>">&nbsp;</i> 我的乐购
            </a>
        </li>
    </ul>
    <div class="smailnav">
