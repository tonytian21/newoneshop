...
<style type="text/css">
    ...
    .head_search .ico_search {
        background: url("<?php echo G_TEMPLATES_IMAGE; ?>/mix-icon.png") no-repeat -120px -100px;
        display: block;
        height: 17px;
        width: 19px;
        z-index: 1000;
...
<header class="header" style="position: fixed; width: 100%;z-index: 99999999;background: #edebeb;border-bottom: 1px solid #d8d8d8;">
        ...
        <h1 style="width: 100%;text-align: center;float: none;top: 0px;left: 0px;font-size: 25px;" class="fl">
            <div class="head_search b_red" style="position: relative;margin: 0 50px 0 30px;">
                <input style="background: #fff;margin-top: 9px;" id="txtSearch" class="init" placeholder="输入'小米手机'试一试" type="text">
                <!--
                <span style="">
          ...
          -->
            ...
            <a class="search_submit" id="butSearch" href="javascript:;" style="color: #f60;line-height: 52px;font-size: 16px;display: block;float:right;margin-right: 15px;">搜&nbsp索
            </a>
        ...
        <a class="daohangguanbi" onclick="history.go(-1)" href="javascript:;"><img width="30" height="30" src="<?php echo G_TEMPLATES_IMAGE; ?>/fanhui1.png"></a>
<!--
...
<script src="<?php echo G_TEMPLATES_JS; ?>/mobile/ajax.js"></script>
	<section class="goodsCon" style="position: relative;top: 49px;">
		<div class="goodsNav" style="color: #888;background: #f4f4f4;padding-left: 10px;">
			找到&nbsp<em class="orange"><?php echo $list; ?></em>&nbsp个关于“<em class="orange"><?php echo $search; ?></em>”的商品
		</div>
