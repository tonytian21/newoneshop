<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="groups-right">
	...
	<div class="grhead-img"><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia(uidcookie('uid')); ?>" class="fl-img">		
		...
		<img style="border-radius: 100px;" src="<?php echo G_TEMPLATES_STYLE; ?>/images/prmimg.jpg" width="50" height="50" />
		<?php  else: ?>
		<img style="border-radius: 100px;" id="imgUserPhoto" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo userid(uidcookie('uid'),'img'); ?>" width="50" height="50" border="0"/>
		<?php endif; ?>
	</a>	
	</div>
	<div class="grhead-info">
		...
		<div id="divJoinGroup">
	        <p id="pJoinGroup" class="grhead-join gray02"> 加入圈子<span id="spJoinGroupNum" class="orange"><?php echo qznum(); ?></span><b></b></p>
	    </div>
	</div>	
	<?php  else: ?>
