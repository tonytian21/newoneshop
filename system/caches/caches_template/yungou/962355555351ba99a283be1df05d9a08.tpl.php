<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="left">
	...
	<div class="sidebar-nav">
		...
		<p class="sid-line"></p>
		<h3 class="sid-icon03 " >
			<a href="javascript:void();"><b></b>圈子管理 <s class="sid_ss" title="收起"></s></a>
		</h3>
		<ul>
		...
		<p class="sid-line"></p>
		<h3 class="sid-icon04 " >
			<a href="javascript:void();"><b></b>邀请管理 <s class="sid_ss" title="收起"></s></a>
		</h3>
		<ul>
		...
		<p class="sid-line"></p>		
		<h3 class="sid-icon05 " >
			<a href="javascript:void();"><b></b>账户管理 <s class="sid_ss" title="收起"></s></a>
		</h3>
		<ul>
		...
		<p class="sid-line"></p>
		<h3 class="sid-icon07 sid-hcur" hasChild="0" url=""><a href="<?php echo WEB_PATH; ?>/member/home/userfufen"><b></b>我的积分</a></h3>
