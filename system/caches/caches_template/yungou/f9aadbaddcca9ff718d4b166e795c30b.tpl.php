		...
		<div class="site_top">
			...
			<div class="head_top w1200">
				...
				<ul class="collect fr">
					...
					<li class="fr">
						<a class="livechatinc" style="text-indent: 25px;margin-right: 0 !important;" class="service_img" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo _cfg("qq"); ?>&site=qq&menu=yes" target="_blank">在线客服</a>
					</li>
					<li class="fr">
					...
					<li class="fr yu_ff">
						...
						<a  href="<?php echo WEB_PATH; ?>/home/member">我的乐购</a>
						<span>|</span>
						...
						<div class="h_1yyg_eject">
							...
							<dl>
								...
								<dd>
									<a  href="<?php echo WEB_PATH; ?>/member/home">我的乐购</a>
								</dd>

								<dd>
									<a  href="<?php echo WEB_PATH; ?>/member/home/userbuylist">乐购记录</a>
								</dd>
				...
				<ul class="collect fl">
					...
					<!--<li class="fl mobile" style="position:relative;width: 50px;padding:0 25px;">
						<a target="_blank" style="margin:0;" href="<?php echo G_WEB_PATH; ?>/app/index.html">手机乐购</a>
						<s style="left: 80px;"></s>
						<span  class="shouji"></span>
						<div class="h_mobile" style="padding:0 25px;width: 50px;height: 140px;z-index: 9999;">
							<dl>
								<li class="fl mobile">
									<a target="_blank"  style="margin:0;color: #ff6600;" href="<?php echo G_WEB_PATH; ?>/app/index.html">手机乐购</a>
									<s style="left: 80px;"></s>
