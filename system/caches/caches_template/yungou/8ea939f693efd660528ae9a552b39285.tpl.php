...
<div class="R-content">
	...
	<div class="goods-tit gray02">
		<p class="fl">本期商品您总共云购<span><?php echo $record['gonumber']; ?></span>人次 拥有<span><?php echo $record['gonumber']; ?></span>个云购码</p><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" class="blue fr" style="margin-right: 20px;">&lt;&lt; 返回列表</a>
	</div> 
	...
	<div class="list-tab goodsList" id="userbuylist">
		...
		<ul><li class="leftTitle"><?php echo microt($record['time']); ?></li>
			...
			<li class="Code" style="width: 670px;"><?php echo yunma($record['goucode']); ?></li></ul>
	</div>

	<div class="goods-tit gray02">
		<a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" class="blue fr" style="margin-right: 20px;">&lt;&lt; 返回列表</a></div>
</div>
