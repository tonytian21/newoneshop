...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-pay-lst"  style="padding-top:60px;">
		...
		<p class="g-pay-Total gray9">合计：<span class="orange arial Fb F16"><?php echo $MoenyCount; ?></span> 乐币</p>
    ...
    <div style="margin: 10px 10px 0px 10px;">
	    <article class="clearfix m-round g-pay-ment" style="border: 1px solid #dcdcdc;border-radius: 5px;box-shadow:1px 1px 1px #e7e7e7;overflow: hidden;">
			...
			<?php if($Money >= $MoenyCount): ?>			
				...
				<span>您可以使用余额付款（账户余额：<?php echo $Money; ?> 乐币）</span>
				</li>
			<?php  else: ?>
				...
				<span>您的余额不足（账户余额：<?php echo $Money; ?> 乐币）</span>
				</li> 
			<?php endif; ?>
		    </ul>
	    </article>
...
var Path = new Object();
Path.Skin = "<?php echo G_WEB_PATH; ?>/statics//yungou";
