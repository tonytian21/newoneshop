	...
	<div id="ltlContents" class="help-right-part">
		<div class="help-right-part">
			<div class="help-in-rihgt-part">
				...
				.help-nav ul li a.cur<?php echo $article['id']; ?> b{width:4px; height:4px; overflow:hidden; background:#f60; display:inline-block!important; position:absolute; left:-10px; top:5px;}
				.help-nav ul li a.cur1 b{display: none;}
				</style>
