	...
	<div id="GoodsList" class="goods_show">
		...
		<ul class="goods_list">	
			...
			<li class="gname"style="margin:10px 0 0 0;">
				<a target="_blank" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $rt['shopid']; ?>_<?php echo $rt['shopqishu']; ?>">第(<?php echo $rt['shopqishu']; ?>)期 <?php echo $rt['shopname']; ?></a>
