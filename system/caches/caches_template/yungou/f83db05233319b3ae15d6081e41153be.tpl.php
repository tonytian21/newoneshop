...
<div class="login_layout" style="width:1200px;">
	...
	<div class="login_ConInput registerform" style="float: left;">
		<form method="post" action="" enctype="application/x-www-form-urlencoded">
		<dl>
			<dd class="zhanghao"><input id="ipyanz" datatype="m | e" sucmsg="帐号验证通过！" nullmsg="请填写帐号！" placeholder="手机号/邮箱地址！" type="text" name="name" class="inputxt" /><b class="passport-icon"></b></dd>
			<dd><div style="margin:7px 0 0 10px;" class="Validform_checktip"></div></dd>
		</dl>
		<dl>
			<dd class="mima"><input id="mima" datatype="*6-20" plugin="passwordStrength" nullmsg="请设置密码！" placeholder="密码，6-20字母或数字" type="password" name="userpassword" class="inputxt" maxlength="20"/><b style="top:31px;height: 20px;background-position: 0 -25px;" class="passport-icon"></b></dd>
			<dd>
				<div style="margin:7px 0 0 10px;" class="Validform_checktip"></div>
		...
		<dl>
			<dd class="mima"><input id="mima" tip="test"  datatype="*" recheck="userpassword" nullmsg="请再输入一次密码！" errormsg="您两次输入的账号密码不一致！" placeholder="确认输入密码" type="password" name="userpassword2" class="inputxt" maxlength="20"/><b style="top:31px;height: 20px;background-position: 0 -25px;" class="passport-icon"></b></dd>
			<dd><div style="margin:7px 0 0 10px;" class="Validform_checktip"></div></dd>
		</dl>
		<dl>
				 <dd class="yanzheng"><input id="yanzheng" type="text" ajaxurl="<?php echo WEB_PATH; ?>/member/user/codeCheck"  datatype="*4-6" nullmsg="请输入验证码！" errormsg="请输入正确的验证码！" placeholder="验证码" ajaxurl="<?php echo WEB_PATH; ?>/member/user/codeCheck"   class="inputxt" name="captcha" type="text" /></dd>
	...
	<div class="Service_Agreement" style="width:1100px;">    
	    <h2>服务协议</h2>
	    ...
	    <p>5、用户在成为<?php echo _cfg("web_name"); ?>的会员后，可按<?php echo _cfg("web_name"); ?>的积分规则享受积分获得。累积积分可用于积分商城中的相应积分商品兑换。积分规则连同与该规则相关的条款和条件，构成用户与<?php echo _cfg("web_name"); ?>之间的完整协议。接受本协议，即表明接受积分规则中的条款和条件。</p>
