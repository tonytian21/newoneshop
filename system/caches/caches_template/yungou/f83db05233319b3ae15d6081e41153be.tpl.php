...
<div class="login_layout" style="width:1200px;">
	...
	<div class="login_ConInput registerform" style="float: left;">
		...
		<dl>
			<dd class="zhanghao"><input id="ipyanz" datatype="m | e" sucmsg="帐号验证通过！" nullmsg="请填写帐号！" placeholder="邮箱地址！" type="text" name="name" class="inputxt" /><b class="passport-icon"></b></dd>
